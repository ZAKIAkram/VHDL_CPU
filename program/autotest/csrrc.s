#TAG = csrrc
    ...
    csrrc x0, mstatus, x1 # Machine Interrupt Enable bit (MIE de mstatus) `a 1
    ...
    addi x1, x1, 1 # bit 11 = 0x800 => 0x7ff + 1, car constante 12 bits sign´ee pour addi
    # les deux lignes pr´ec´edentes ´etant ´equivalente `a li x1,0x800
    csrrc x0, mie, x1 # Machine Extern Interrupt Enable bit (MEIE de mie) `a 1
    addi x2, x0, 0
attente:
